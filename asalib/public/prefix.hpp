...
namespace AbelianSquaresAnalysis {
	...
	namespace prefix {
		...
		struct prefixAnalysisOutputSquareType {
		...
		struct AnalysePrefixOutput {
			prefixAnalysisOutputSquareType total; ///< List and information on the number of total abelian squares.
			prefixAnalysisOutputSquareType distinct; ///< List and information on the number of distinct abelian squares.
			prefixAnalysisOutputSquareType nonequivalent; ///< List and information on the number of non-equivalent abelian squares.
		};
		...
		struct prefixAnalysisOutput : morphism::morphismOutput, prefix::AnalysePrefixOutput {
			...
			/// @brief Constructor of class from base AbelianSquaresAnalysis::morphism::morphismOutput.
			/// @param[in] base Reference to parent morphismOutput. This will copy of data on the generated of the prefix on which the analysis is performed.
			/// @param[in] base2 Reference to parent AnalysePrefixOutput, included for backwards compatibility.
			asalib prefixAnalysisOutput(const morphism::morphismOutput& base, const prefix::AnalysePrefixOutput& base2);
		};
		...
		/// @param[in] data input AbelianSquaresAnalysis::prefix::prefixAnalysisOutput.
		/// @see AbelianSquaresAnalysis::prefix::prefixAnalysisOutput
		...
		void asalib AnalysePrefix(types::word input, prefix::AnalysePrefixOutput& output);
		...
		void asalib SquaresCountTrivials(prefixAnalysisOutputSquareType& input);
	}
